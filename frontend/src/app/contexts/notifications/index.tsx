...
export const NotificationProvider: React.FC<Props> = ({ children }) => {
  ...
  function pushNotification(
    ...
    const previousNotifications = clearAll ? [] : notifications;
    if (Array.isArray(notification))
      setNotifications([...previousNotifications, ...notification]);
    else setNotifications([...previousNotifications, notification]);
  }
